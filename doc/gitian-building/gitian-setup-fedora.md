...
The build script we'll be using is contained in the xbi github repository ([contrib/gitian-build.py](https://github.com/xbi-project/xbi/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the xbi repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/xbi-Project/xbi/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, xbi-detached-sigs, and xbi GitHub repos.
