xbi Core version v5.3.1 is now available from: https://github.com/xbi-project/xbi/releases
...
If you are running an older version, shut it down. Wait until it has completely shut down, then run the installer (on Windows) or just copy over /Applications/xbi-Qt (on Mac) or xbid/xbi-qt (on Linux).
