...
To build xbi Core using AFL instrumentation (this assumes that the
...
with certain assembly code from xbi Core's code. See [developer notes on sanitizers](https://github.com/xbi/xbi/blob/master/doc/developer-notes.md#sanitizers)
