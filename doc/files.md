...
xbi.conf           | contains configuration settings for xbid or xbi-qt
xbid.pid           | stores the process id of xbid while running
...
debug.log           | contains debug information and general logging generated by xbid or xbi-qt
