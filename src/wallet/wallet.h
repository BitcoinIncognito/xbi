...
enum WalletFeature {
    ...
    FEATURE_PRE_xbi = 61000, // inherited version..
...
public:
     ...
     * xbi: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 3000 XBI output and keys which can be used for the Masternode
