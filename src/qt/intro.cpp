...
static const uint64_t BLOCK_CHAIN_SIZE = 4 * GB_BYTES;
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the xbi.conf file in the default data directory
     * (to be consistent with xbid behavior)
     */
