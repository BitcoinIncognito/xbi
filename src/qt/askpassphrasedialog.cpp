...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            xbiGUI* window = static_cast<xbiGUI*>(parentWidget());
...
{
    xbiGUI* gui = static_cast<xbiGUI*>(parentWidget());
...
{
    hide();
    static_cast<xbiGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your XBIs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
