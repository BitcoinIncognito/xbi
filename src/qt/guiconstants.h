...
// Copyright (c) 2015-2018 The xbi developers
...
/* xbi GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "xbi"
#define QAPP_ORG_DOMAIN "xbi.org"
#define QAPP_APP_NAME_DEFAULT "xbi-Qt"
#define QAPP_APP_NAME_TESTNET "xbi-Qt-testnet"
