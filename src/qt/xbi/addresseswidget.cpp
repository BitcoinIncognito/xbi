...
#include "qt/xbi/forms/ui_addresseswidget.h"
#include "qt/xbi/addressfilterproxymodel.h"
#include "qt/xbi/addresslabelrow.h"
...
AddressesWidget::AddressesWidget(xbiGUI* parent) :
    PWidget(parent),
