...
#ifndef xbi_CORE_NEW_GUI_xbiGUI_H
#define xbi_CORE_NEW_GUI_xbiGUI_H
...
#include "qt/xbi/navmenuwidget.h"
#include "qt/xbi/topbar.h"
#include "qt/xbi/dashboardwidget.h"
#include "qt/xbi/send.h"
#include "qt/xbi/receivewidget.h"
#include "qt/xbi/addresseswidget.h"
#include "qt/xbi/coldstakingwidget.h"
#include "qt/xbi/masternodeswidget.h"
#include "qt/xbi/snackbar.h"
#include "qt/xbi/settings/settingswidget.h"
...
/**
  xbi GUI main class. This class represents the main window of the xbi UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class xbiGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit xbiGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~xbiGUI();
...
#endif //xbi_CORE_NEW_GUI_xbiGUI_H
