...
#include "qt/xbi/txviewholder.h"
#include "qt/xbi/tooltipmenu.h"
#include "qt/xbi/sendmultirow.h"
#include "qt/xbi/coldstakingmodel.h"
#include "qt/xbi/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(xbiGUI* parent);
    ~ColdStakingWidget();
