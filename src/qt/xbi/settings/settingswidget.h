...
#include "qt/xbi/settings/settingsbackupwallet.h"
#include "qt/xbi/settings/settingsexportcsv.h"
#include "qt/xbi/settings/settingsbittoolwidget.h"
#include "qt/xbi/settings/settingssignmessagewidgets.h"
#include "qt/xbi/settings/settingswalletrepairwidget.h"
#include "qt/xbi/settings/settingswalletoptionswidget.h"
#include "qt/xbi/settings/settingsmainoptionswidget.h"
#include "qt/xbi/settings/settingsdisplayoptionswidget.h"
#include "qt/xbi/settings/settingsinformationwidget.h"
#include "qt/xbi/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(xbiGUI* parent);
    ~SettingsWidget();
