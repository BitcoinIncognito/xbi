...
#include "qt/xbi/settings/settingsnetworkwidget.h"
#include "qt/xbi/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/xbi/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(xbiGUI* _window, QWidget *parent) :
