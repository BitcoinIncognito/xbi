...
#include "qt/xbi/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/xbi/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(xbiGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to xbiGUI::handleRestart()
