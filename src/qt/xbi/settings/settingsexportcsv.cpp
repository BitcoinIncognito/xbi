...
#include "qt/xbi/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(xbiGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("xbi_tx_csv_export(*.csv)") : tr("xbi_addresses_csv_export(*.csv)"),
                                        nullptr);
