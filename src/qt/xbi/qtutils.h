...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, xbiGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, xbiGUI* gui, double posX = 3);
