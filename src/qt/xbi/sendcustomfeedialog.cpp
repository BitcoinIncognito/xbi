...
#include "qt/xbi/sendcustomfeedialog.h"
#include "qt/xbi/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(xbiGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &xbiGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
