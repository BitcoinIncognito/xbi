...
const int XBIESKTOP_NOTIFICATION_ICON_SIZE = 128;
#endif
...
#ifdef USE_DBUS
    interface = new QDBusInterface("org.xbiesktop.Notifications",
        "/org/xbiesktop/Notifications", "org.xbiesktop.Notifications");
...
void Notificator::notifyDBus(Class cls, const QString& title, const QString& text, const QIcon& icon, int millisTimeout)
{
    ...
    hints["icon_data"] = FreedesktopImage::toVariant(tmpicon.pixmap(XBIESKTOP_NOTIFICATION_ICON_SIZE).toImage());
    args.append(hints);
