/* src/config/xbi-config.h.  Generated from xbi-config.h.in by configure.  */
/* src/config/xbi-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/xbi-project/xbi/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "xbi Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xbi Core 5.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xbi"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.xbi.org/"
