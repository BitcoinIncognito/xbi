...
//
// The Masternode Class. It contains the input of the 3000 XBI, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 3000 XBI - checking if valid masternode)
