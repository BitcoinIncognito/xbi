...
#error Client version information missing: version is not defined by xbi-config.h or in any other way
#endif
...
/**
 * xbid-res.rc includes this file, but it cannot cope with real c++ code.
