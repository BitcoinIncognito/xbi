Contributing to xbi Core
============================

The xbi Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/xbi/xbi/blob/master/doc/translation_process.md)
...
The following applies to code changes to the xbi Core project, and is not to be
confused with overall xbi Network Protocol consensus changes.

Whether a pull request is merged into xbi Core rests with the project merge
...
Patches that change xbi consensus rules are considerably more involved than
...
Where a patchset proposes to change the xbi consensus, it must have been
...
The project leader is the release manager for each xbi Core release.
