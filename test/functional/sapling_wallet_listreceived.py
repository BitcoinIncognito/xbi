...
class ListReceivedTest (xbiTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 XBI.
        ...
        # Send 1 XBI to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 XBI sending them all (fee is 0.1 XBI)
        ...
        # Confirm transaction (2 XBI from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 XBI, send 0.6 XBI + 0.05 XBI fee
