...
# Copyright (c) 2020-2021 The xbi developers
...
class FullBlockTest(xbiTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure xbid isn't accepting b26
        ...
        # Extend the b28 chain to make sure xbid isn't accepting b28
        ...
        # xbi: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the xbi code has custom code which does so);
