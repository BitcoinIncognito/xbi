#!/usr/bin/env python3
# Copyright (c) 2020 The xbi Core developers
...
class SaplingMempoolTest(xbiTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 XBI note to Alice
        ...
        # miner sends another 10 XBI note to Alice
