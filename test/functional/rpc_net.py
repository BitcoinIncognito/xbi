...
class NetTest(xbiTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 7339)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 7339)
