...
By default, xbid will dump mempool on shutdown and
...
class MempoolPersistTest(xbiTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent xbid from writing mempool.dat to disk. Verify that `savemempool` fails")
