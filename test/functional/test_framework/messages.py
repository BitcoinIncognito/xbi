...
COIN = 100000000 # 1 XBI in satoshis
...
# Objects that map to xbid objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in xbid indicates these should be deserialized as blocks
