...
class DIP3Test(xbiTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 XBI) to the operator, and (2 * 2.7 XBI) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid xbi address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid xbi address InvalidPayee", controller.protx_update_registrar,
