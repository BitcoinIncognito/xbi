...
class ReorgStakeTest(xbiTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        # verify that nodes have the expected XBI supply
    ...
    def run_test(self):
        ...
        # Verify that XBI supply was properly updated after the reorgs (including burned fee)
        self.log.info("Check XBI supply...")
